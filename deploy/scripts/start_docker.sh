...
docker pull 051826734860.dkr.ecr.ap-southeast-2.amazonaws.com/campusx_ecr:v3
...
# Run a new container
docker run -d -p 80:5000 -e DAGSHUB_PAT=e691c7193ab61dc9678e31c6b92ded8a65f80697 --name campusx-app 051826734860.dkr.ecr.ap-southeast-2.amazonaws.com/campusx_ecr:v3
